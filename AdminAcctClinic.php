...
<html lang="en">
  <head>
    ...
    <title>Admin Account Management (Clinic Information)</title>
  ...
  <div class="row">
    ...
    <section style="background-color: #99ccff;">
       ...
       <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="row">
          <h3>Account Management (Admin) - Clinics </h3>         
        </div>
      </div>
      </div>
    </section>
...
while($row = $result->fetch_assoc()){
    ...
    <a class='my-button' href='AdminEditClinic.php?clinicID=$row[clinicID]'>Edit</a>
    <a class='my-button' href='AdminDeleteClinic.php?clinicID=$row[clinicID]'>Delete</a>
    </td>
