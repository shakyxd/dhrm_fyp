...
<html lang="en">
  <head>
    ...
    <title>Admin Account Management (Staff Information)</title>
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
          <a class="nav-link" href="AdminRegisterClinic.php">
    ...
    <section style="background-color: #99ccff;">
       ...
       <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="row">
          <h3>Admin Account Management (Staff Information)</h3>         
        </div>
      </div>
      </div>
    </section>
...
while($row = $result->fetch_assoc()){
    ...
    <td>$row[staffID]</td>
    <td>$row[clinicID]</td>
	<td>$row[emailStaff]</td>
	<td>$row[phoneNumStaff]</td>
	<td>$row[staffType]</td>
  ...
  <td>$row[genderStaff]</td>
  <td>$row[dateOfBirthStaff]</td>
	<td>

  <a class='my-button' href='AdminEditStaff.php?staffID=$row[staffID]'>Edit</a>
    <a class='my-button' href='AdminDeleteStaff.php?staffID=$row[staffID]'>Delete</a>
