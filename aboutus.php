      ...
      <div class="col">
        <div class="row row-cols-1 row-cols-sm-2 g-4">
          <div class="col d-flex flex-column gap-2">
            ...
            <h4 class="fw-semibold mb-0">Quality</h4>
            <p class="text-muted">To deliver you the best and high-quality oral care </p>
          </div>

          <div class="col d-flex flex-column gap-2">

            <h4 class="fw-semibold mb-0">Freedom of choice</h4>
            <p class="text-muted">Choice is yours to decide as we provide a wide variety of services that are available</p>
          </div>

          <div class="col d-flex flex-column gap-2">

            <h4 class="fw-semibold mb-0">Team</h4>
            <p class="text-muted">Only experienced and dedicated team </p>
          </div>

          <div class="col d-flex flex-column gap-2">

            <h4 class="fw-semibold mb-0">Service</h4>
            <p class="text-muted">Prioritizing accessibility in all services we provide to you </p>
          </div>
        </div>
      </div>
    </div>
