            ...
            <section style="background-color: #99ccff;">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="container py-5">
                        <div class="row">
                            <h3>View All Appointments (Admin)</h3>
                        </div>
                    </div>
            </section>
                                                ...
                                                <tbody>
                                                    ...
                                                    while($row = $result->fetch_assoc()){
	                                                    ...
	                                                    <tr>
                                                            ...
                                                            echo "<td>
                                                                <a class='btn btn-sm btn-outline-secondary' href='AdminEditAppointment.php?id=$row[appointmentID]'>Edit</a>
                                                                <a class='btn btn-sm btn-outline-secondary' href='AdminDeleteAppointment.php?id=$row[appointmentID]'>Delete</a>
                                                            </td>";
                                                    }
